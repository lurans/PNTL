            ...
            function($scope, $rootScope, $state, $sce, $compile, $timeout, configFlowServ){
                ...
                $scope.probeStartBtnOK = function(){
                    ...
                    var installConfirmWindow = {
                        ...
                        height : "250px",
                        width : "400px",
                        content: "<p style='color: #999'><span style='font-size: 14px;color: #ff9955'>" + i18n.chkFlow_term_start_Probe_btn + "</span>" + i18n.chkFlow_term_start_Probe_explain + "</p><p style='text-align:center;margin-top: 15px;color: #999;font-size: 14px;'>" + i18n.chkFlow_term_confirm_start + "</p>",
                        closeable:false,
                        resizable:false,
                        buttons:[{
                            key:"btnOK",
                ...
                $scope.probeStopBtnOK = function(){
                    ...
                    var installConfirmWindow = {
                        ...
                        height : "250px",
                        width : "400px",
                        content: "<p style='color: #999'><span style='font-size: 14px;color: #ff9955'>" + i18n.chkFlow_term_stop_Probe_btn + "</span>" + i18n.chkFlow_term_stop_Probe_explain + "</p><p style='text-align:center;margin-top: 15px;color: #999;font-size: 14px;'>" + i18n.chkFlow_term_confirm_stop + "</p>",
                        closeable:false,
                        resizable:false,
                        buttons:[{
                            key:"btnOK",
