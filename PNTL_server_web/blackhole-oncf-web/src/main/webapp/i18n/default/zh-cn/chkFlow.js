define([], function () {
    ...
    var chkFlow = {
        ...
        "chkFlow_term_deploy_alert_label":"探测工具首次部署后，用户可以根据需求在参数配置项设置相关信息",
        "chkflow_term_config_ok":"设置成功！",
        "chkflow_term_config_err":"设置失败！",
        "chkflow_term_deploy_ok":"部署成功！",
        "chkflow_term_deploy_err":"部署失败！",
        "chkFlow_term_detect_interval_time_name":"探测周期",
        "chkFlow_term_detect_packets_number_name":"发包个数",
        "chkFlow_term_detect_max_time_delay_name":"最大时延",
        "chkFlow_term_detect_max_loss_rate_name":"最大丢包率",
        "chkFlow_term_detect_interval_time_detail":"单位=s,值=-1(杀死进程),0(关闭),1~60",
        "chkFlow_term_packets_num_detail":"单位=pcs,值>0",
        "chkFlow_term_max_time_delay_detail":"单位=ms,值>=0",
        "chkFlow_term_max_loss_rate_detail":"单位=%,值>=0",
        "chkFlow_term_confirm":"提交",
        "chkFlow_term_confirm_window":"确认窗口",
        "chkFlow_term_negative":"-1：表示杀死",
        "chkFlow_term_zero":"0：表示关闭",
