define([], function () {
    ...
    var chkFlow = {
        ...
        "chkFlow_term_start_Probe_btn":"Start",
        "chkFlow_term_stop_Probe_btn":"Stop",
        "chkFlow_term_file_upload":"File Upload",
        "chkFlow_term_start_Probel_explain":":The Agent probe tool is started by restoring the probing cycle to the initial default value.",
        "chkFlow_term_stop_Probel_explain":":The agent probing process is stopped by setting the probing period to 0, and the Agent probing process still exists.",
        "chkFlow_term_confirm_start":"Sure to start?",
        "chkFlow_term_confirm_stop":"Sure to stop?",
        "chkFlow_term_upload_explain":":Make sure to add and delete operations, the file upload process takes 1 to 2 minutes, please be patient.",
        "chkFlow_term_confirm_upload":"Sure to upload?",
        "chkFlow_term_install_file_upload":"Upload Install Packages and ipList.yml ",
        ...
        "chkFlow_term_start_probe_confirm":"Start Probe Confirm",
        "chkFlow_term_stop_probe_confirm":"Stop Probe Confirm",
        "chkFlow_term_upgrade_config":"Upgrade",
        "chkFlow_term_alert_label":"Explanation",
        "chkFlow_term_show_label":"NO DATA",
        "chkFlow_term_upgrade_alert_label1":"Upgrade:",
        "chkFlow_term_upgrade_alert_label2":"Installation Package Upgrade:",
        "chkFlow_term_upgrade_alert_label4":"Only upload installation package files, ServerAntAgentForEuler.tar.gz and ServerAntAgentForSles.tar.gz.",
        "chkFlow_term_confirm_install":"Sure to install?",
        "chkFlow_term_install_explain":":In the first deployment, install and start the agent detection tool, which only ipList.yml file in the host installation operation, the installation process takes 1 to 2 minutes, please be patient.",
        "chkFlow_term_upgrade_alert_label5":"IP Update：",
        "chkFlow_term_upgrade_alert_label6":"Upload *.yml and choose corresponding operation can update ip list.",
        "chkFlow_term_upgrade_alert_label3":"The user can update installation package and ip list by upgrade.",
        ...
        "chkFlow_term_kafka_port":"Kafka Port",
        ...
        "chkFlow_term_deploy_alert_label1":"Before the first deployment of the probe tool, the user can upload related files in config file upload option,set the related parameter in deploy parameter config option.",
        ...
        "chkFlow_term_init_submit_err":"History Info Get Failed!",
        "chkFlow_term_ip_upgrade_success":"IP Upgarde Success!",
        "chkFlow_term_ip_upgrade_fail":"IP Upgarde Failed!",
        "chkFlow_term_agent_alert_label1":"Agent Config:",
        "chkFlow_term_agent_alert_label2":"After installed probe tool,the user can control Agent probe tool in Varianle Config and Start and Stop Settings.",
        "chkFlow_term_probe_interval_time_name":"Probe Interval Time",
        "chkFlow_term_delay_alert_label":"Network Delay:",
        "chkFlow_term_delay_alert_label1":"The delay between different hosts in the network. There are 6 kinds of display status, different colors that different network delay interval.",
        "chkFlow_term_loss_alert_label":"Network Packet Loss:",
        "chkFlow_term_loss_alert_label1":"The packet loss between different hosts in the network. There are 6 kinds of packet loss status, different colors that different network packet loss probability interval.",
        ...
        "chkFlow_term_max_loss_pkg_num_name":"Loss Packet Numbers Threshold",
        "chkFlow_term_pkg_size":"Packet Size",
        ...
        "chkFlow_term_repo_ip":" Repo IP",
        "chkFlow_term_probe_interval_time_detail":"s",
        "chkFlow_term_probe_interval_tooltip":"Please input 1~120 and less than Probe Interval Time",
        "chkFlow_term_probe_port_count_detail":"pcs",
        "chkFlow_term_pkg_size_detail":"byte",
        "chkFlow_term_probe_port_count_tooltip":"Please input 1~100",
        "chkFlow_term_report_interval_time_detail":"s",
        "chkFlow_term_report_interval_time_tooltip":"Please input 5~300 and greater than Probe Interval Time",
        ...
        "chkFlow_term_max_time_delay_tooltip":"Please input an integer 1~2000",
        ...
        "chkFlow_term_lossPkg_timeout_tooltip":"Please input an integer 1~5",
        "chkFlow_term_lossPkg_num_tooltip":"Please input an integer 1~10",
        "chkFlow_term_pkg_size_tooltip":"Please input an integer 40~2000",
        "chkFlow_term_ak_detail":"",
        "chkFlow_term_ak_tooltip":"plaese input digit, alphabet or _ , and the max length is 30",
        "chkFlow_term_topic_tooltip":"plaese input digit, alphabet or _ , and the max length is 20",
        ...
        "chkFlow_term_kafka_port_tooltip":"Please input 0~65535",
