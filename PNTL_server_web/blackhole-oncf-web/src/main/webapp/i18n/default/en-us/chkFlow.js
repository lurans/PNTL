define([], function () {
    ...
    var chkFlow = {
        ...
        "chkFlow_term_start_Probe_explain":":The agent probe tool is started by restoring the probe cycle to the initial default value.",
        "chkFlow_term_stop_Probe_explain":":The agent probe tool is stopped by setting the probe cycle to 0, and the agent probe process still exists.",
        "chkFlow_term_confirm_start":"Sure to start?",
        "chkFlow_term_confirm_stop":"Sure to stop?",
        "chkFlow_term_upload_explain":":Make sure to add and delete operations, this process need 1 to 2 minutes, please be patient.",
        ...
        "chkFlow_term_upgrade_alert_label2":"Install Package Upgrade:",
        "chkFlow_term_upgrade_alert_label4":"Only upload install package files, ServerAntAgentForEuler.tar.gz and ServerAntAgentForSles.tar.gz.",
        "chkFlow_term_confirm_install":"Sure to install?",
        "chkFlow_term_install_explain":":In the first deployment, install and start the agent probe tool,it only installs the host which containing the ipList.yml file, the install process need 1 to 2 minutes, please be patient.",
        ...
        "chkFlow_term_deploy_alert_label1":"Before the first deployment of the probe tool, the user must upload related files in config file upload option,and set the related parameter in deploy parameter config option.",
        ...
        "chkFlow_term_agent_alert_label2":"After installed the probe tool,the user can control the agent probe tool by Variable Config and Start or Stop Settings.",
        "chkFlow_term_probe_interval_time_name":"Probe Interval Time",
        "chkFlow_term_delay_alert_label":"Network Delay:",
        "chkFlow_term_delay_alert_label1":"The delay between different hosts in the network. There are 6 kinds of display status, and different colors represent different network delay interval.",
        "chkFlow_term_loss_alert_label":"Network Packet Loss:",
        "chkFlow_term_loss_alert_label1":"The packet loss between different hosts in the network. There are 6 kinds of packet loss status, and different colors represent different packet loss rate interval.",
