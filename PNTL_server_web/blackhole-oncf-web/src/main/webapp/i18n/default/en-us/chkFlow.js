define([], function () {
    ...
    var chkFlow = {
        ...
        "chkFlow_term_kafka_port":"Kafaka Port",
        ...
        "chkFlow_term_delay_alert_label1":"Delay probability of different host in networking,there are six states of display,disconnect,show that the host is not connect,other colors show different network delay section.",
        "chkFlow_term_loss_alert_label":"Network Packet Loss:",
        "chkFlow_term_loss_alert_label1":"Packet loss probability of different host in networking,there are six states of display,disconnect,show that the host is not connect,other colors show different network packet loss section.",
