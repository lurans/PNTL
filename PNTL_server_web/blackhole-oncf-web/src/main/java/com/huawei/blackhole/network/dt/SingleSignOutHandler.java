...
public final class SingleSignOutHandler {
     ...
     */
    public static final HashMapBackedSessionMappingStorage sessionMappingStorage = new HashMapBackedSessionMappingStorage();
    ...
    /**
     * @param name Name of parameter containing CAS logout request message for
     *             back channel SLO.
     */
    ...
    /**
     * @param name Name of parameter containing the state of the CAS server
     *             webflow.
     */
    ...
    public boolean process(final HttpServletRequest request, final HttpServletResponse response) {
        if (isTokenRequest(request)) {
            ...
            OPERATE_LOG.info("back channel logout request {} {}", request.getMethod(), request.getMethod());
            ...
            OPERATE_LOG.info("front channel logout redict to url:{}", redirectionUrl);
    ...
    private String uncompressLogoutMessage(final String originalMessage) {
        final byte[] binaryMessage = Base64.decodeBase64(originalMessage.getBytes(Charsets.UTF_8));
