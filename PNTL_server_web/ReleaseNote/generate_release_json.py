...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 4 :
        ...
        print "  1) team name, this value can be: ConsoleFramework|ECS_UI|APICOM|VPC|AutoScalling|CloudEye|MeterTicket|ApiGateway|FusionSphere "
        print "  2) package name, this value can be: ConsoleFramework|ECS_UI|APICOM|VPC|AutoScalling|CloudEye|MeterTicket|ApiGateway|OpsNetworkChkFlow "
    ...
    team_name = "FusionSphere"
    package_name = "OpsNetworkChkFlow"
    ...
    result = {"team_name": team_name, "package_name": package_name, "package_type": package_type, "release_date": release_date, "release_version": release_version, "release_note": release_note}
    result = json.dumps(result, encoding="utf-8", ensure_ascii=False)
  
    jsonfile = package_name + "-" + release_version + "-release.json"
